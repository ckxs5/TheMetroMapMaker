...
public class MetroMapStyle {
    ...
    public static final String CLASS_COLOR_BUTTON = "color_button";
    ...
    public static final String CLASS_BORDER_PANE = "bordered_pane";
    public static final String CLASS_RECENT_WORK = "recent_work";
    public static final String CLASS_WELCOME = "welcome_pane";
    public static final String CLASS_GRID = "grid";
